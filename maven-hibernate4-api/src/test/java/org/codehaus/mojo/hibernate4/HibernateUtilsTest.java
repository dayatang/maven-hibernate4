    ...
    extends TestCase
{
    ...
    public static final String DIRECTORY_PATH = "org/codehaus/mojo/hibernate4";

    public static final String DUMMY_CLASS = "org.codehaus.mojo.hibernate4.DummyBean";

    public static final String DUMMY_WRONG_CLASS = "org.codehaus.mojo.hibernate4.DummyWrongBean";

    public static final String FILE_PATH = "org/codehaus/mojo/hibernate4/DummyBean.class";
