...
import org.codehaus.mojo.hibernate4.HibernateUtils;
 ...
 * @version $Id: GenericExporterMojo.java 7043 2008-05-23 16:43:30Z jreyes $
 * @goal hbmtemplate
 */
...
// --------------------------- CONSTRUCTORS ---------------------------
    ...
    {
        addDefaultComponent( "target/hibernate4/generic", "jdbcconfiguration", false );
        addDefaultComponent( "target/hibernate4/generic", "jdbcconfiguration", true );
    }
