...
import org.codehaus.mojo.hibernate4.configuration.ComponentConfiguration;
import org.codehaus.mojo.hibernate4.exporter.Component;
...
/**
 * Base class for the different hibernate4 goals based on the Ant tasks of hibernate tools.
 *
...
// ------------------------------ FIELDS ------------------------------
     ...
     *
     * @component role="org.codehaus.mojo.hibernate4.configuration.ComponentConfiguration"
     * @noinspection MismatchedQueryAndUpdateOfCollection
     */
...
// --------------------- Interface Mojo ---------------------
        ...
        throws MojoExecutionException, MojoFailureException
    {
        ...
        try
        {
            ...
            {
                getLog().info( "skipping hibernate4 execution" );
            }
            else
            {
                doExecute();
